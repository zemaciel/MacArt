...
<!-- TOC --><a name="deployment-1"></a>
# Deployment



<!-- TOC --><a name="deploying-the-site"></a>
## Deploying the site

<!-- TOC --><a name="heroku-app-setup"></a>
### Heroku app setup
...
<!-- TOC --><a name="preparation-for-deployment"></a>
...
<!-- TOC --><a name="generate-a-secret-key"></a>
...
<!-- TOC --><a name="creating-aws-groups-policies-and-users"></a>
...
<!-- TOC --><a name="connecting-django-to-our-s3-bucket"></a>
...
<!-- TOC --><a name="to-fork-a-repository"></a>
...
<!-- TOC --><a name="to-clone-a-repository"></a>
